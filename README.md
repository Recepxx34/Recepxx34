...
|https://www.binance.com/en/my/wallet/account/main/deposit/crypto/BTC------------------------------| wallet/account/main/deposit/crypto/BTC--------------------------------------------------------- | -wallet/account-------- |---main--------|
...
If you have an idea and want to make it a BEP, you may refer [BEP-1](./BEPs/BEP1.md) # Bnb-zinciri-beb
